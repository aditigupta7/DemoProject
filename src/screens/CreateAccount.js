    ...
    return (
        ...
        <View style={{backgroundColor:COLORS.white,width:widthToDp(100),height:heightToDp(100),paddingTop:widthToDp(10)}}>
          ...
          <View style={{marginLeft:widthToDp(10), marginBottom:widthToDp(5)}}>
                <Text style={{fontSize:widthToDp(5),fontFamily:'Nunito-Bold'}}>Create Account</Text>
            </View>
           ...
           <Text style={{fontFamily:'Nunito-Regular'}}>Your Name</Text>
                <TextInput
                    style={styles.input}
           ...
           <View style={styles.inputSection}>
               <Text style={{fontFamily:'Nunito-Regular'}}>Phone Number</Text>
                <TextInput
                    style={styles.input}
        ...
        <View>
            ...
            <Text style={{fontSize:widthToDp(4),color:COLORS.newPurple,fontFamily:'Nunito-ExtraBold',marginTop:widthToDp(5)}}>.Login</Text>
        </View>
        <View>
