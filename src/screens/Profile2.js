...
export default function Profile2({navigation}) {
    return (
      <View style={styles.container}>
          <View style={{flexDirection:'row',backgroundColor:COLORS.lightblue,paddingVertical:widthToDp(4),paddingHorizontal:widthToDp(4)}}>
               ...
               <View style={{marginLeft:widthToDp(33)}}>
                   <Text style={{fontSize:widthToDp(4),color:COLORS.white}}>Profile</Text>
                </View>
       ...
       <View style={styles.profileConatiner}>
            ...
            <View style={{alignItems:'center', marginTop:widthToDp(4)}}>
                ...
                <AntDesign name="edit" size={15} color={COLORS.white} style={styles.iconStyle}/>
      ...
      <View style={{flexDirection:'column',marginTop:widthToDp(5)}}>
        ...
        <View style={styles.settingContainer}>
          <View style={styles.settingItem}>
            <MaterialIcons name="logout" size={24} color={COLORS.dark}/>
            <View style={{marginLeft:widthToDp(4)}}>
